            ...
            if($result -> num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    if ($row['case_name'] == null) {
                        ...
                        echo "<p><img src='./item_img/container/" . ucwords($row['container_name']) . ".png' alt='{$row['container_name']}' class='item-img-case'> " . ucwords($row['container_name']) . "</p>";
                        ...
                        echo "<p><img src='./item_img/case/" . ucwords($row['case_name']) . ".png' alt='{$row['case_name']}' class='item-img-case'> " . ucwords($row['case_name']) . "</p>";
                    }
                    echo "</a>";
                }
            } else {
